...
import type {} from '@greeneek/gnk-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@greeneek/gnk-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@greeneek/gnk-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@greeneek/gnk-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@greeneek/gnk-skill-filesystem"}\n',
