...
的运行机制——模式、fixture、golden，以及与 `gnk web` 之间刻意保留的组合差异——记录在
...
`@greeneek/gnk-client-web` import `AppWebEntry`、从
`@greeneek/gnk-client-modules/client` import boot manifest 类型：启动真实 shell 正是该
