...
import * as GoalSessionInvariant from '@greeneek/gnk-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@greeneek/gnk-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@greeneek/gnk-invariants'
import SessionStore, { SessionId, type Session } from '@greeneek/gnk-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@greeneek/gnk-goal-round-driver',
    }))
  })
