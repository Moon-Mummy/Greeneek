 ...
 * `@greeneek/gnk-output-retention` (`TextRetainer`), storage is `ctx.spillStore`.
...
import type { PostToolDecision, ToolExecution } from '@greeneek/gnk-tools'
