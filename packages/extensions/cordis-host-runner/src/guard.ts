 ...
 * @module @greeneek/gnk-cordis-host-runner/guard
 */

import { Context } from '@greeneek/cordis'
import type { Plugin } from '@greeneek/cordis'
import { scopeOf } from '@greeneek/gnk-scope'
import { assertSupportedJsonSchema, defineTool } from '@greeneek/gnk-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@greeneek/gnk-cordis-client-runner`, whose CTX_VERBS names this one its
