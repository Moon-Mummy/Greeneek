...
import type { ProcessInspectorInternals } from '@greeneek/gnk-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@greeneek/gnk-subprocess-local/src/windows-inspector.ts'
