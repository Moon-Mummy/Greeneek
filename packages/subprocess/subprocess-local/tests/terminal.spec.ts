...
import { LocalTerminalHandle } from '@greeneek/gnk-subprocess-local/src/terminal.ts'
import { createProcessInspector } from '@greeneek/gnk-subprocess-local/src/process-inspector.ts'
import type {
  ProcessIdentity,
  ProcessInspector,
...
import type { SubprocessTerminalSignal } from '@greeneek/gnk-subprocess'
