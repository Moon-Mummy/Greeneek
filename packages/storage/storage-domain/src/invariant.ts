/**
 * Package-owned invariant companion for `@greeneek/gnk-storage-domain`: every
 ...
 * @module @greeneek/gnk-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@greeneek/gnk-storage-domain'
