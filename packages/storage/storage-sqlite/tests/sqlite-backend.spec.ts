...
import Storage, { storageBackendServiceKey } from '@greeneek/gnk-storage'
import type { KvUnitDescriptor } from '@greeneek/gnk-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'gnk-storage-sqlite-'))
  dirs.push(dir)
