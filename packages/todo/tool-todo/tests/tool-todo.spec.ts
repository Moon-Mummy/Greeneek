...
import { Session, SessionId, SessionLogOffset } from '@greeneek/gnk-session'
import type { TodoItem } from '@greeneek/gnk-tool-todo'
...
/**
 * Drives the REAL plugin body: mounts `gnk-tool-todo` on a real `ToolRuntime`
