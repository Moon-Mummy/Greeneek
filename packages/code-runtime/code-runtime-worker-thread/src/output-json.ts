/** JSON string-prefix accounting for the outer-output ledger. @module @greeneek/gnk-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@greeneek/gnk-code-runtime'
