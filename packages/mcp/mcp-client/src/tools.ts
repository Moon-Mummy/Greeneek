 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the Greeneek function-name
...
import { isImageAdmissionError } from '@greeneek/gnk-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@greeneek/gnk-attachment'
import type { ContentBlock } from '@greeneek/gnk-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@greeneek/gnk-tools'
import { assertSupportedJsonSchema } from '@greeneek/gnk-tools'
import type { JsonSchemaNode } from '@greeneek/gnk-tools'
...
/**
 * Greeneek function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** Greeneek function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the Greeneek function-name contract (64 chars,
