/**
 * End-to-end tests for gnk-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@greeneek/gnk-mcp-client/src/index.ts'
import { publicToolName } from '@greeneek/gnk-mcp-client/src/tools.ts'
import type { Config } from '@greeneek/gnk-mcp-client'
...
async function mountImageRegistry(gnkHome: string): Promise<Context> {
  const ctx = await mountRegistry()
  await ctx.plugin(LocalAttachmentStore, { gnkHome })
