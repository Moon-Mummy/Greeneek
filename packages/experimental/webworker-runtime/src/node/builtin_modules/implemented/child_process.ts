 ...
 * @module @greeneek/gnk-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { GNK_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? GNK_ROOT
