 ...
 * @module @greeneek/gnk-experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like gnk-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/gnk', vfs = new MemoryVfs()): MemoryVfs {
