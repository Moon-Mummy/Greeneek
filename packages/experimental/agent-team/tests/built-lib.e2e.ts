...
describe.skipIf(!requiredArtifacts)('Agent Teams built LIB service', () => {
  it('loads the Host service and its generated browser contribution under plain Node', async () => {
    ...
    expect(output).toEqual({
      ...
      methods: [
        '@greeneek/gnk-experimental-agent-team#agentTeams/createTask',
        '@greeneek/gnk-experimental-agent-team#agentTeams/updateTask',
        '@greeneek/gnk-experimental-agent-team#agentTeams/view',
      ],
    })
  })
})
