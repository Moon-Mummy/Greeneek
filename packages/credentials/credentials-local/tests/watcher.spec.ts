...
const KEY = credentialRef('GNK_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'gnk-credentials-watch-'))
