 ...
 *
 * @module @greeneek/gnk-api-settings-controller/src/credentials.ts
 */

import { Context } from '@greeneek/cordis'
import { credentialRef } from '@greeneek/gnk-credentials'
import type { CredentialProvider } from '@greeneek/gnk-credentials'
  ...
  private provider(): CredentialProvider {
    ...
    if (credentials === undefined) {
      throw new RemoteError(
        'gateway/internal',
        'credentials service is absent: this deployment does not mount a credential provider (e.g. @greeneek/gnk-credentials-local) in its composition',
        {},
      )
    }
    return credentials
