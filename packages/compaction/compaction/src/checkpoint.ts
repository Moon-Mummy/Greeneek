 ...
 *
 * The seam itself lives in `@greeneek/gnk-compaction`, which re-exports these
 ...
 * `gnk-commands/brand` shape.
 *
 * @module @greeneek/gnk-compaction/checkpoint
 */

import type { MessageSource } from '@greeneek/gnk-llm/message'
