 ...
 *
 * @module @greeneek/gnk-compaction-basic/summarizer
 */

import type { Context } from '@greeneek/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@greeneek/gnk-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'gnk-compaction-basic' },
    }),
  ]
