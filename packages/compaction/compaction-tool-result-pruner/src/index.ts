 ...
 *
 * @module @greeneek/gnk-compaction-tool-result-pruner
 */

import { Context, Service } from '@greeneek/cordis'
import z from '@greeneek/schemastery'
import { freezeMessage } from '@greeneek/gnk-llm'
import type { ContentBlock } from '@greeneek/gnk-llm'
import type { Session, SessionEvent, SessionSeq, ToolResultMessage } from '@greeneek/gnk-session'
