 ...
 * @module @greeneek/gnk-workflow-worker-thread/meta
 */

import { WorkflowError } from '@greeneek/gnk-workflow'
import type { WorkflowMeta, WorkflowPhase } from '@greeneek/gnk-workflow'
