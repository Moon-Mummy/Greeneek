...
import { installModelSelection, type ModelSelection, type ModelSelectionRef } from '@greeneek/gnk-agent'
import { ReasoningEffortId, type LlmCallConfig, type LlmRuntime } from '@greeneek/gnk-llm'

const MODEL_CONFIG_ID = 'model'
const REASONING_CONFIG_ID = 'reasoning_effort'
// GNK reasoning effort ids are non-empty, so the empty opaque ACP value is a disjoint provider-default choice.
