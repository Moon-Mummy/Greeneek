...
import { SlotCore, standardHookPropName } from '@greeneek/gnk-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@greeneek/gnk-client-ui-slots').KeyedStandardSource> = {}
