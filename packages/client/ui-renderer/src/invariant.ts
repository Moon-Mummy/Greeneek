/**
 * Package-owned invariant companion for `@greeneek/gnk-client-ui-renderer`.
 * @module @greeneek/gnk-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@greeneek/gnk-client-ui-slots'
import type { InvariantInstaller } from '@greeneek/gnk-invariants'

const PACKAGE_NAME = '@greeneek/gnk-client-ui-renderer'
