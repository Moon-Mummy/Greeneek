...
import type { TerminalBlockLabels, TerminalBlockProps } from '@greeneek/gnk-client-ui-primitives'
...
function shellCall(name: string, args: Record<string, unknown>): ShellCall | null {
  ...
  if (description === undefined) {
    // Standard gnk-tool-bash and gnk-tool-pwsh schemas require `description`;
...
/**
 * Parse the marker literals owned by `@greeneek/gnk-shell/render` without
