...
import type { ToolCallOwnerProps } from '@greeneek/gnk-client-ui-tool/client'
import { IconGlobeOutline14 } from '@greeneek/gnk-client-ui-primitives'
import { webCardModel } from '../src/client/tool/models/web-card-model.ts'
import { createChatStore } from '@greeneek/gnk-client-ui-chat/src/client/stores.ts'
import { GenericToolCard } from '../src/client/tool/toolviews/GenericToolCard.tsx'
import { DetailsPanel } from '@greeneek/gnk-client-ui-chat/src/client/details/DetailsPanel.tsx'
...
import { zh } from '@greeneek/gnk-client-ui-conversation/src/client/locales.ts'
import { zh as chatZh } from '@greeneek/gnk-client-ui-chat/src/client/locale.ts'
...
const SEARCH_ARGS = '{"queries":["greeneek harness"]}'
...
describe('webCardModel', () => {
  ...
  it('accepts open-root extensions while validating declared web arguments', () => {
    expect(webCardModel(settledSearch({
      call: { name: 'web_search', argsRaw: '{"queries":["greeneek"],"extension":1}' },
    }))).not.toBeNull()
    expect(webCardModel(settledSearch({
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@greeneek/cordis').Context
