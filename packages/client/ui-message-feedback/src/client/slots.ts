 ...
 * @module @greeneek/gnk-client-ui-message-feedback/client/slots
 */
...
import type { MessageId } from '@greeneek/gnk-api-remotes/client'
import type { MessageFeedbackRating } from '@greeneek/gnk-message-feedback/types'
