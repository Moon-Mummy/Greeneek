 ...
 * determinism
 * lives host-side — the pre-step boundary (`gnk-tool-skill`) recognizes a
...
import type { SkillEntry } from '@greeneek/gnk-api-remotes/client'
import type {} from '@greeneek/gnk-api-session-controller/client'
import type { SessionId } from '@greeneek/gnk-session/types'
import type { InputTriggerServiceContract, InputTriggerSource } from '@greeneek/gnk-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (gnk-tool-skill) recognizes the leading /name and
