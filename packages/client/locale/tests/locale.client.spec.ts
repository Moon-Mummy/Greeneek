...
import { stubSettingsScope, type StubSettingsScope } from '@greeneek/gnk-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@greeneek/gnk-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@greeneek/gnk-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (gnk-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared GNK home agrees', () => {
