...
const INDIRECTION_PREFIX = '--gnk-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--gnk-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--gnk-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--gnk-scrollbar-width)`); a rename in scrollbar.css without
