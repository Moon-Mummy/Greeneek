...
import { commandDefinition } from '@greeneek/gnk-client-ui-chat/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@greeneek/gnk-client-ui-chat/src/client/conversation-nodes/chat-snapshot-builder.ts'
