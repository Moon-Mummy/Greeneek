...
import type { GoalSnapshot } from '@greeneek/gnk-goal/client'
import {
...
export type GoalDockProps = import('@greeneek/gnk-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
