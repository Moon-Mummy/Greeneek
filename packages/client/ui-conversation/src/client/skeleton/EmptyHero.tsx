...
/**
 * The hero mark uses the existing Greeneek logo. Decorative — hidden from the
 * accessibility tree; the surrounding headline provides the text context.
 * @returns the Greeneek logo element.
 */
function HeroLogo() {
  return <FishLogo size={34} className={css.fish} />
}
