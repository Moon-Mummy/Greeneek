 ...
 * @module @greeneek/gnk-agent-loop/invariant
 */

import type { Context } from '@greeneek/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@greeneek/gnk-llm'
import type { InvariantFailure, InvariantInstaller } from '@greeneek/gnk-invariants'
import { foldRequestHeader } from '@greeneek/gnk-session'

const PACKAGE_NAME = '@greeneek/gnk-agent-loop'
