 ...
 * @module gnk-agent-loop/tests/cancel
 */
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED_BEFORE_DISPATCH } from '@greeneek/gnk-tools'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // gnk-llm-retry opens when its backoff waits after appending llm/retry.
