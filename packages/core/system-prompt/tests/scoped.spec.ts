...
import { createScope, scopeOf } from '@greeneek/gnk-scope'
import type { Scope, ScopeKey } from '@greeneek/gnk-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@greeneek/gnk-system-prompt'
import type { Config, PromptAssembly } from '@greeneek/gnk-system-prompt'
