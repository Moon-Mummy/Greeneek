 ...
 *
 * @module @greeneek/gnk-system-prompt
 */

import { Context, Service } from '@greeneek/cordis'
import z from '@greeneek/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@greeneek/gnk-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@greeneek/gnk-scope'
import type { ContextSnapshotSection, ToolSchema } from '@greeneek/gnk-llm'
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        text: 'You are an AI agent powered by Greeneek.',
      })
    }
    this.section({
