 ...
 * ([`gnk-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @greeneek/gnk-agent-tool-presentation
 */

import type { Context } from '@greeneek/cordis'
import z from '@greeneek/schemastery'
import type { ToolPresentationMode } from '@greeneek/gnk-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `gnk-agent-presets` reports as an unusable row, naming this id.
