/**
 * @greeneek/gnk-cmdline — the command line a gnk launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `gnk --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
