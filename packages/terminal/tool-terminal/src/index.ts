 ...
 * @module @greeneek/gnk-tool-terminal
 */
...
import { TerminalSessionId } from '@greeneek/gnk-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@greeneek/gnk-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @greeneek/gnk-jobs and @greeneek/gnk-tool-jobs')
