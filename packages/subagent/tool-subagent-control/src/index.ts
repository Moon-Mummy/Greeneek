 ...
 * `@greeneek/gnk-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @greeneek/gnk-tool-subagent-control
 */
...
import type {} from '@greeneek/gnk-subagent'
import { markAdjacentAgentSendMessageTool } from '@greeneek/gnk-subagent/internal'
