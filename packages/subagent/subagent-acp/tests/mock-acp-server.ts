 ...
 * `gnk-subagent-acp` tests. It speaks the agent side of ACP over stdio and is
 ...
 *
 * @module @greeneek/gnk-subagent-acp/tests/mock-acp-server
 */
...
createAcpAgentApp({ name: 'gnk-subagent-acp-test-agent' })
