...
import type { Session, SessionHeader, SessionId } from '@greeneek/gnk-session'
import type { SessionProjectionRegistry } from '@greeneek/gnk-session-projection'
import type { SessionProjectionCache } from '@greeneek/gnk-session-projection-cache'
import type { SessionObservation, SessionQueryEngine } from '@greeneek/gnk-session-query'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @greeneek/gnk-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @greeneek/gnk-session)',
  ...
  if (query === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionQuery service (load @greeneek/gnk-session-query)',
