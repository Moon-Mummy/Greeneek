 ...
 * @module @greeneek/gnk-subagent-in-process-driver/structured
 */

import type { Context } from '@greeneek/cordis'
import type { ToolSchema } from '@greeneek/gnk-llm'
import type { ToolExecution, ToolRunContext } from '@greeneek/gnk-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@greeneek/gnk-tools'
 ...
 *   `assertObjectJsonSchema` in gnk-tools).
