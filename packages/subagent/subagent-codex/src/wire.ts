 ...
 *
 * @module @greeneek/gnk-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@greeneek/gnk-llm'
import type { SubagentResult } from '@greeneek/gnk-subagent'
import { JsonRpcLineTransport } from '@greeneek/gnk-sdk-protocol'
