/**
 * Unit + real-load-path coverage for @greeneek/gnk-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@greeneek/gnk-llm'
import SystemPrompt from '@greeneek/gnk-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@greeneek/gnk-tools'
import * as timeoutPolicy from '@greeneek/gnk-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@greeneek/gnk-tool-call-timeout-policy'
...
describe('gnk-tool-call-timeout-policy real-load-path guard', () => {
