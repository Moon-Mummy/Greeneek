...
import type { EntryInfo, Sandbox } from '@greeneek/gnk-e2b'

const VERSION_METADATA_KEY = 'gnk-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.gnk-${randomUUID()}.tmp`)
