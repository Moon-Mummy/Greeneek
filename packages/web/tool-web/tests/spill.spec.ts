 ...
 * (`gnk-spill-local` backend + `gnk-spill-policy`), exercised through
...
import LocalSpillStore from '@greeneek/gnk-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'gnk-spill-web-'))
