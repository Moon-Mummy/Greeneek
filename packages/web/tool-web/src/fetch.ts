...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@greeneek/gnk-tools'
import type { WebFetchBody, WebFetchResult } from '@greeneek/gnk-web'
import { assertNever, type JsonValue } from '@greeneek/gnk-util-values'
 ...
 * `@greeneek/gnk-tool-call-timeout-policy`, not a model argument.
 *
