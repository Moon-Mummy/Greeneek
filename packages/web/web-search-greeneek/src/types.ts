/**
 * Provider-private wire types for Greeneek's Anthropic-compatible Messages API. Citeable
 ...
 * @module @greeneek/gnk-web-search-greeneek/types
 */
...
/** Greeneek's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** Greeneek's error response envelope (best-effort; fields vary). */
