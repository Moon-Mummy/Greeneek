 ...
 * and leaves presentation to `@greeneek/gnk-tool-web`. Requests carry no browser cookies
 * or ambient credentials.
 * @module @greeneek/gnk-web-fetch-http/provider
 */

import { WebError } from '@greeneek/gnk-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@greeneek/gnk-web'
