/**
 * OpenTelemetry Service Provider for the Greeneek Harness telemetry capability.
 *
 ...
 *
 * @module @greeneek/gnk-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@greeneek/schemastery'
import type { Context } from '@greeneek/cordis'
import type {} from '@greeneek/gnk-command-feedback'
import {
...
} from '@greeneek/gnk-session-telemetry'
import { APP_IDENTITY } from '@greeneek/gnk-llm'
...
// version (same pattern as gnk-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@greeneek/gnk-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@greeneek/gnk-session-telemetry-otel/ops', version)
