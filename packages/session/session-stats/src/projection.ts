 ...
 * (`deriveStats` in gnk-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @greeneek/gnk-session-stats/projection
 */

import { z } from 'zod'
import type { StreamChunk } from '@greeneek/gnk-llm/types'
