 ...
 *
 * @module @greeneek/gnk-session-persistence/tests/contract
 */

import { describe, expect, it } from 'vitest'
import { SessionSeq, SESSION_FORMAT_VERSION, SessionId } from '@greeneek/gnk-session'
import type { SessionEvent, SessionHeader } from '@greeneek/gnk-session'
import { MessageId, freezeMessage } from '@greeneek/gnk-llm'
import {
