 ...
 *
 * @module @greeneek/gnk-tool-session-query/workspace-access
 */
...
import type { TurnBoundaryProjection } from '@greeneek/gnk-agent'
import type {
  SessionLineageNode,
  SessionRecord,
} from '@greeneek/gnk-session-query'
import type { ToolRunContext } from '@greeneek/gnk-tools'
