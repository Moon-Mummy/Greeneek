 ...
 *
 * @module @greeneek/gnk-session-query
 */
...
import { foldSessionTitle } from '@greeneek/gnk-session-title'
import type { SessionTitleSnapshot } from '@greeneek/gnk-session-title'
import type {
