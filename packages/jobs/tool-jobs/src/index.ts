 ...
 * @module @greeneek/gnk-tool-jobs
 */

import type { Context } from '@greeneek/cordis'
import z from '@greeneek/schemastery'
import { boundContextSummary, createUserMessage, type ContentBlock } from '@greeneek/gnk-llm'
import { TextRetainer } from '@greeneek/gnk-output-retention'
import { defineTool } from '@greeneek/gnk-tools'
import type { GenericCallView, ToolDefinition, ToolExecution } from '@greeneek/gnk-tools'
import { JobId } from '@greeneek/gnk-jobs'
import type { JobSnapshot } from '@greeneek/gnk-jobs'
