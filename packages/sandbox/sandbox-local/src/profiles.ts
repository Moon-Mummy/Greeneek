 ...
 *
 * @module @greeneek/gnk-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@greeneek/node-addon-landlock-run'
 ...
 * (`@greeneek/gnk-fs-sandbox`) can never drift apart.
