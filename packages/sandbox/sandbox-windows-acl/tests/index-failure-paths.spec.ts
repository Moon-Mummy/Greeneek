...
import { Win32Error } from '@greeneek/gnk-win32-process'
import { ERROR_BROKEN_PIPE } from '@greeneek/gnk-win32-process/src/abi.ts'
import { PROCESS_INFORMATION } from '@greeneek/gnk-win32-process/src/ffi.ts'
...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), 'gnk-acl-index-'))
