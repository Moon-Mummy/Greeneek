...
import {
  ...
  isNullPtr,
  throwLastError,
} from '@greeneek/gnk-win32-process'
import type { NativePtr, Win32ProcessBindings } from '@greeneek/gnk-win32-process'
...
export type { NativePtr } from '@greeneek/gnk-win32-process'
