 ...
 * streams large files, and rejects binary data; line windows belong to `gnk-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @greeneek/gnk-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@greeneek/gnk-fs'
