 ...
 *
 * @module @greeneek/gnk-tool-fs-search/grep
 */

import type { Context } from '@greeneek/cordis'
import { defineTool } from '@greeneek/gnk-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@greeneek/gnk-tools'
import type { RetainedItems } from '@greeneek/gnk-output-retention'
import type { SpillRef } from '@greeneek/gnk-spill'
