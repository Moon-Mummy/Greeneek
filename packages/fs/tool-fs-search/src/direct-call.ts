/** Shared top-level-call post-policy selection for search result spill. @module gnk-tool-fs-search/direct-call */

import type { Context } from '@greeneek/cordis'
import type { PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@greeneek/gnk-tools'
