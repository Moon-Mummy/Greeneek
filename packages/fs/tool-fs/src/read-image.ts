 ...
 * @module @greeneek/gnk-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@greeneek/cordis'
import { AttachmentError, AttachmentId } from '@greeneek/gnk-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@greeneek/gnk-attachment'
import type { ContentBlock } from '@greeneek/gnk-llm'
import { defineTool } from '@greeneek/gnk-tools'
import type { GenericCallView, ToolExecution } from '@greeneek/gnk-tools'
