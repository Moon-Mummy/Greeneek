 ...
 * @module @greeneek/gnk-tool-fs/src/write
 */

import type { Context } from '@greeneek/cordis'
import { defineTool } from '@greeneek/gnk-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@greeneek/gnk-tools'
import type { FsWriteOutcome } from '@greeneek/gnk-fs'
