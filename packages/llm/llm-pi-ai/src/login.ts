...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@greeneek/gnk-authorization'
import { isCredentialKeySegment } from '@greeneek/gnk-credentials'
