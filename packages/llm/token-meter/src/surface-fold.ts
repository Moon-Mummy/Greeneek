 ...
 *
 * @module @greeneek/gnk-token-meter/surface-fold
 */

import { deriveEventMessage } from '@greeneek/gnk-session'
import type { SessionSeq, SurfaceEvent } from '@greeneek/gnk-session'
