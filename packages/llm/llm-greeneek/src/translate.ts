/**
 * Translate Greeneek SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate Greeneek wire chunks into the harness `StreamChunk` protocol.
 * @module gnk-llm-greeneek/translate
 */

import { brandString } from '@greeneek/gnk-brand'
import { EMPTY_RESPONSE_CODE, LlmError } from '@greeneek/gnk-llm'
import type { ContentBlock, FinishReason, StreamChunk, TokenUsage, ToolCallId } from '@greeneek/gnk-llm'
...
/**
 * Map wire usage fields. Greeneek's `prompt_tokens` INCLUDES cache hits
