 ...
 * Greeneek protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module gnk-llm-greeneek/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@greeneek/gnk-llm'

/** The terminal payload Greeneek (and OpenAI) send after the last chunk. */
