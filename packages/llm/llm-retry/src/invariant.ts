/** Package-owned durable retry-event invariants. @module @greeneek/gnk-llm-retry/invariant */

import type { Context } from '@greeneek/cordis'
import type { Session, SessionEvent } from '@greeneek/gnk-session'
import type { LlmFailure } from '@greeneek/gnk-llm'
...
const PACKAGE_NAME = '@greeneek/gnk-llm-retry'
