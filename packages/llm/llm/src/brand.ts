/**
 * gnk-llm's owned branded ids: tool-call correlation and provider request
 * diagnostics.
 *
 * The `Branded<B>` primitive and stateless constructor live in
 * `@greeneek/gnk-brand` so every owner of a cross-boundary id can brand it
 * without depending on gnk-llm; see that package's README for the
 * nominal-typing policy.
 *
 * @module @greeneek/gnk-llm/brand
 */
