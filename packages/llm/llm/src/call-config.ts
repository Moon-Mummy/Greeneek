 ...
 * @module gnk-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by gnk-agent-loop. */
...
/**
 * Mark one exact request object as assembled by gnk-agent-loop.
...
/**
 * Test whether the exact request object was assembled by gnk-agent-loop.
