...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@greeneek/gnk-llm'
import type { AppIdentity } from '@greeneek/gnk-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `greeneek-harness/${manifest.version} (+https://github.com/greeneek/greeneek-harness)`,
    )
  })
