...
describe('gnk-sdk-app bundle', () => {
  it('declares startup-gated JSON-RPC serving without overriding base HMR policy', () => {
    ...
    expect(manifest.dependencies).toHaveProperty('@greeneek/gnk-sdk-jsonrpc-server')
    ...
    expect(rows.find(row => row.id === 'sdk-app-startup')?.name).toBe('@greeneek/gnk-sdk-app')
