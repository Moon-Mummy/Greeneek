 ...
 * `ctx.lsp` → `gnk-lsp-stdio` stack over the base protocol, exercising all four operations. No API
...
import Lsp, { type LspQueryRequest, type LspQueryResult } from '@greeneek/gnk-lsp'
