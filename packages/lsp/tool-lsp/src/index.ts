 ...
 * `gnk-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @greeneek/gnk-tool-lsp
 */

import type { Context } from '@greeneek/cordis'
import z from '@greeneek/schemastery'
import { defineTool } from '@greeneek/gnk-tools'
import { LspError } from '@greeneek/gnk-lsp'
import type {} from '@greeneek/gnk-lsp'
