/**
 * gnk-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@greeneek/gnk-brand`; this module
 ...
 * loading the host plugin's Context merges — the `gnk-llm/brand` shape.
 *
 * @module @greeneek/gnk-commands/brand
 */
