 ...
 *
 * @module @greeneek/gnk-session-reference
 */
...
import { createUserMessage, freezeMessage } from '@greeneek/gnk-llm'
import type { ContentBlock, UserMessage } from '@greeneek/gnk-llm'
...
import type { ProjectionSnapshot } from '@greeneek/gnk-session-projection'
import type {} from '@greeneek/gnk-session-projection-cache'
import type {} from '@greeneek/gnk-session-title'
import type { SessionRecord, SessionSurfaceSnapshot } from '@greeneek/gnk-session-query'
import {
