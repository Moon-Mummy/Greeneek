...
import { isCompactCheckpointSource } from '@greeneek/gnk-compaction'
import type { SessionSurfaceSnapshot } from '@greeneek/gnk-session-query'
...
import type { OptionalSessionSeq } from '@greeneek/gnk-session'
