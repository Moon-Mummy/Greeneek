 ...
 *
 * @module @greeneek/gnk-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$GNK_HOME`.
 * Discovery (`$GNK_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.gnk/AGENTS.md' || displayPath === '$GNK_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
