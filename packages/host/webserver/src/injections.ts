...
/**
 * Tail script settling the boot-readiness deferred (`__GNK_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__GNK_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
