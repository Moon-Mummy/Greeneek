...
import { DirectoryPickerError } from '@greeneek/gnk-host-directory-picker'
import type { DirectoryPickerBrowseCapability } from '@greeneek/gnk-host-directory-picker'
...
beforeAll(async () => {
  root = await mkdtemp(join(tmpdir(), 'gnk-browse-'))
