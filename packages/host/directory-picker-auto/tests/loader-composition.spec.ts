...
import type { DirectoryPicker } from '@greeneek/gnk-host-directory-picker'
import BrowseDirectoryPicker from '@greeneek/gnk-host-directory-picker-browse'
import NativeDirectoryPicker from '@greeneek/gnk-host-directory-picker-native'
...
const AUTO = '@greeneek/gnk-host-directory-picker-auto'
const NATIVE = '@greeneek/gnk-host-directory-picker-native'
const BROWSE = '@greeneek/gnk-host-directory-picker-browse'
const NATIVE_SURFACE = '@greeneek/gnk-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@greeneek/gnk-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  root = await mkdtemp(join(tmpdir(), 'gnk-directory-picker-auto-'))
...
function stubAttendedHost(): void {
  fakeBin = mkdtempSync(join(tmpdir(), 'gnk-picker-bin-'))
