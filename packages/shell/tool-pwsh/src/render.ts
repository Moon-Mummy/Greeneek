 ...
 * `gnk-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @greeneek/gnk-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@greeneek/gnk-shell'
...
/* jscpd:ignore-start -- deliberate twin of gnk-tool-bash/render.ts (Agent Note). */
