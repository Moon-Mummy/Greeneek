 ...
 * twin of `gnk-tool-bash`'s background adaptation.
 *
 * @module @greeneek/gnk-tool-pwsh/background
 */

import type { ShellProcess } from '@greeneek/gnk-shell'

/* jscpd:ignore-start -- deliberate twin of gnk-tool-bash/background.ts (Agent Note). */
