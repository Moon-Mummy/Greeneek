 ...
 * to `@greeneek/gnk-jobs`; this seam exposes only process handles. The
 ...
 * root.
 * @module gnk-shell/types
 */

import type { SandboxEnforcement, SandboxExecutionPolicy, SandboxMode } from '@greeneek/gnk-sandbox'
import type { CollectedOutput, GnkEnvironment } from '@greeneek/gnk-subprocess'

export { GNK_ENV_PREFIX } from '@greeneek/gnk-subprocess'
export type { CollectedOutput, GnkEnvironment, GnkEnvironmentKey } from '@greeneek/gnk-subprocess'
