 ...
 * mirror of `@greeneek/gnk-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @greeneek/gnk-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@greeneek/gnk-shell'
import type { RunnerFailureRule } from '@greeneek/gnk-sandbox'
