 ...
 *
 * @module @greeneek/gnk-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@greeneek/gnk-shell'
import type { SandboxMode } from '@greeneek/gnk-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@greeneek/gnk-sandbox'
 ...
 * rendering story, owned by `@greeneek/gnk-shell` so `gnk-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@greeneek/gnk-shell'
