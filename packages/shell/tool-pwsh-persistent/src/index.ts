 ...
 * @module @greeneek/gnk-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@greeneek/gnk-terminal'
...
const SHELL_PROMPT = '__GNK_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__GNK_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__GNK_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
