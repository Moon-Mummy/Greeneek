 ...
 * @module @greeneek/gnk-command-feedback
 */

import type { Context } from '@greeneek/cordis'
import type { CommandInvocation, CommandResult } from '@greeneek/gnk-commands'
import type { SessionTelemetryBackend, SessionTelemetrySharingStatus } from '@greeneek/gnk-session-telemetry'
