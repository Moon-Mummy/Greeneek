...
import SessionStore, { foldSurface, Session, SessionId } from '@greeneek/gnk-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@greeneek/gnk-session-telemetry'
import * as commandFeedback from '@greeneek/gnk-command-feedback'
...
vi.mock('@greeneek/gnk-anonymous-user-id', () => ({
...
describe('@greeneek/gnk-command-feedback registration', () => {
