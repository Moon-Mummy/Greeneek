/**
 * Named wire types for the Greeneek Harness SDK runtime protocol: the three
 * request/result pairs and the four server-to-client notification payloads
 * exchanged over the newline-delimited JSON-RPC stdio transport. The server
 * plugin (`@greeneek/gnk-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `greeneek-harness-sdk-runtime`.
 *
 * @module @greeneek/gnk-sdk-protocol/types
 */

import type { ContentBlock, ReasoningEffortId } from '@greeneek/gnk-llm'
import type { SessionEvent } from '@greeneek/gnk-session'
import type { SubagentStopReason } from '@greeneek/gnk-subagent'
...
export interface InitializeResult {
  /** Wire-stable server identity (`greeneek-harness-sdk-runtime`) and version. */
