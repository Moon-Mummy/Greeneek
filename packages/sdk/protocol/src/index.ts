/**
 * Shared wire protocol for the Greeneek Harness SDK runtime: the
 ...
 * (`@greeneek/gnk-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@greeneek/gnk-sdk-client`, the Python SDK) drive it.
 *
 * @module @greeneek/gnk-sdk-protocol
 */
