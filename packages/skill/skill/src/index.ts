 ...
 * Concrete
 * providers such as `@greeneek/gnk-skill-filesystem` decide where skills come
 ...
 *
 * @module @greeneek/gnk-skill
 */

import { Context, Service } from '@greeneek/cordis'
import type {} from '@greeneek/gnk-llm'
import { assertNever } from '@greeneek/gnk-util-values'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@greeneek/gnk-scope'
...
export type SkillSource = 'project-gnk' | 'project-agents' | 'runtime' | 'user-gnk' | 'user-agents' | 'custom' | 'bundled' | (string & {})
