 ...
 * @param root - absolute `GNK_HOME/attachments/v1` root.
...
/**
 * Establish this process's proof that one GNK_HOME entry and every ancestor
...
export async function commitPreparedImageFile(
  ...
  // Establish GNK_HOME itself against the filesystem root once per process.
