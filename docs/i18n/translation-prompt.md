...
- Source: `The committed agent workflow lives in .agents/skills/gnk-translate-docs`
- Bad: `进仓的 agent 工作流见 .agents/skills/gnk-translate-docs`
- Good: `仓库内置的 agent 工作流见 .agents/skills/gnk-translate-docs`
...
- Source code block contains: `# full-screen TUI coding agent (needs GREENEEK_API_KEY)`
- Bad: `# 全屏 TUI coding agent（需要 GREENEEK_API_KEY）`
- Good: `# full-screen TUI coding agent (needs GREENEEK_API_KEY)` (keep exactly as-is, byte-for-byte)
