...
Greeneek 仍处于早期阶段，并在积极开发中。很抱歉，我们目前无法接受外部 PR（Pull Request）。不过，贡献代码远非帮助本仓库建设的唯一途径。你还可以通过许多其他方式参与进来：
...
- 为生态系统作出贡献：
  ...
  - 撰写有关 Greeneek 的博客文章和操作指南。
  - 回答问题并帮助其他社区成员。

Greeneek 的设计支持深度定制。我们并不认为官方仓库中的包天然就比社区开发的包更重要。你可以将本仓库看作一种理念、一份官方示例以及一处灵感来源，而不是我们要求社区遵循的方向。
