/**
 * Build the gnk executables and development Node carrier for the Python runtime wheel. The fixed
...
const DEPLOY_ROOT_PACKAGE = 'gnk-python-runtime-closure'
/** The sole application launcher inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@greeneek/gnk/lib/bin.js'
/** Python-visible executable basename. */
const OUTPUT_BASENAME = 'greeneek-harness-sdk-runtime'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/greeneek_harness_runtime/runtime'
...
const ASSET_GLOBS = [
  ...
  'node_modules/@greeneek/gnk-web-frontend/dist/**/*',
  // skill-badge resolves both Markdown and image resources through import.meta.url.
  'node_modules/@greeneek/gnk-skill-badge/assets/**/*',
]
