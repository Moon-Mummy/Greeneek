...
import type { CordisCatalogModel, ServiceMethodEntry } from '@greeneek/gnk-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@greeneek/gnk-tool-cordis/api-catalog', '@greeneek/gnk-cordis-client-runner/client/api-catalog')
