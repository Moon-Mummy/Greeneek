import { Context, Service, type Plugin } from '@greeneek/cordis'
import type { Dict } from '@greeneek/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@greeneek/cordis-plugin-loader'
...
import type {} from '@greeneek/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [greeneek-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
