import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@greeneek/cordis-plugin-loader'
 ...
 * (`gnk --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`gnk --dump-config`) so a dump can never drift from what boots. The input
