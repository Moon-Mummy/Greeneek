...
2. **Brand contract must hold.** App branding, logo, and green theme stay **Greeneek**; model provider/model names stay **Greeneek** (see the Branding and models section in [README.md](README.md)). No upstream "Greeneek Harness" identity as the product name in user-facing docs.
